...
vi.mock('../../code/backend/src/lib/influx.js', () => ({
  writeApi: {
    writePoint: vi.fn(),
  },
}));

vi.mock('../../code/backend/src/services/emailService.js', () => ({
  sendAlertEmail: vi.fn(),
}));

vi.mock('../../code/backend/src/services/telegramService.js', () => ({
  sendTelegramMessage: vi.fn(),
}));

import { initMqtt, publishThresholdConfig } from '../../code/backend/src/services/mqttService.js';
