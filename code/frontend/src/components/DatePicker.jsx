      ...
      */}
      <div className="relative inline-block z-[100]" ref={wrapperRef} id={id}>
        ...
        */}
        ...
        >
          {/* .gdp-input-icon */}
          <span className="text-base opacity-65 inline-flex items-center">
          ...
          {value && (
            <button
              type="button"
              className="bg-transparent border-none cursor-pointer text-[0.85rem] opacity-55 px-[0.1rem] text-inherit leading-none hover:opacity-100 transition-opacity inline-flex items-center justify-center"
              onClick={handleClear}
